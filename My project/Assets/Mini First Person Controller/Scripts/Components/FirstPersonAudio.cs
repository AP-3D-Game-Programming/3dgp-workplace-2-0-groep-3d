...
public class FirstPersonAudio : MonoBehaviour
{
    ...
    // Removed crouch entirely

    AudioSource[] MovingAudios => new AudioSource[] { stepAudio, runningAudio }; // Removed crouchedAudio
    ...
    void SubscribeToEvents()
    {
        ...
        // Removed crouch event subscriptions
    }
    ...
    void UnsubscribeToEvents()
    {
        ...
        // Removed crouch event unsubscriptions
    }
    #endregion
